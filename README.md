...
> [!CAUTION]
> This project started in May 2023. Currently, the AI Agent has moved to the next phase. Its role of allowing users to easily try out vrcagi (AI Agent) has ended. This project has already been archived.

vrcagi UI is designed to make it easier to run and develop with [vrcagi](https://github.com/yoheinakajima/vrcagi) in a web app, like a ChatGPT.
This is a port of [vrcagi](https://github.com/yoheinakajima/vrcagi) with [Langchain.js](https://github.com/hwchase17/langchainjs) and build a user interface.
...
Host your own live version of vrcagi UI with Vercel.
...
[original](https://github.com/yoheinakajima/vrcagi#warning)
...
- The SerpApi team is providing the search API credits for requests made on [the demo site](https://vrcagi-ui.vercel.app/) of this project! ⭐️
