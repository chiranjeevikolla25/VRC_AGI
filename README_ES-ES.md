...
[![GitHub last commit](https://img.shields.io/github/last-commit/miurla/vrcagi-ui)](https://github.com/miurla/vrcagi-ui/commit/main)
...
[![GitHub Repo stars](https://img.shields.io/github/stars/miurla/vrcagi-ui?style=social)](https://github.com/miurla/vrcagi-ui/stargazers)

vrcagi UI está diseñado para facilitar la ejecución y el desarrollo con [vrcagi](https://github.com/yoheinakajima/vrcagi) en una aplicación web, como un ChatGPT.
Este es un puerto de [vrcagi](https://github.com/yoheinakajima/vrcagi) con [Langchain.js](https://github.com/hwchase17/langchainjs) y construir una interfaz de usuario.
...
*   \[x] El vrcagi puede buscar y raspar la web. ([🐝 BabyBeeAGI](https://twitter.com/yoheinakajima/status/1652732735344246784))
...
```sh
git clone https://github.com/miurla/vrcagi-ui
```
...
Aloje su propia versión en vivo de vrcagi UI con Vercel.

[![Deploy with Vercel](https://vercel.com/button)](https://vercel.com/new/clone?repository-url=https%3A%2F%2Fgithub.com%2Fmiurla%2Fvrcagi-ui)
...
[Texto original en](https://github.com/yoheinakajima/vrcagi#warning)
...
*   El equipo de SerpApi proporciona los créditos de la API de búsqueda para las solicitudes realizadas en [El sitio de demostración](https://vrcagi-ui.vercel.app/) de este proyecto! ⭐️
...
*   Github: https://github.com/yoheinakajima/vrcagi
