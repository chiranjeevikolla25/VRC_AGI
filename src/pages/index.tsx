...
function Home() {
  ...
  return (
    <>
      <Head>
        <title>vrcagi-UI</title>
        <meta
          name="description"
          content="vrcagi UI is designed to make it easier to run and develop with vrcagi in a web app, like a ChatGPT."
        />
        <meta name="viewport" content="width=device-width, initial-scale=1" />
        <link rel="icon" href="/favicon.ico" />
        <meta property="og:title" content="vrcagi-UI" />
        <meta
          property="og:description"
          content="vrcagi UI is designed to make it easier to run and develop with vrcagi in a web app, like a ChatGPT."
        />
        <meta property="og:url" content="https://vrcagi-ui.vercel.app/" />
        <meta
          property="og:image"
          content="https://vrcagi-ui.vercel.app/og-image.png"
        />
        <meta name="twitter:card" content="summary_large_image" />
        <meta name="twitter:title" content="vrcagi-UI" />
        <meta
